...
#pragma endregion SYNC_DATA
	...
	explicit cGui::cGui(class cMain *pMain, class cWinAPIFuncs *pWinAPIFuncs, class cInternet *pInternet);
	...
	auto cGui::updateProfile(const std::wstring &wsUserName, const std::wstring &wsProfile) -> void;
